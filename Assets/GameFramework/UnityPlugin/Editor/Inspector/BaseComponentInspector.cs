...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class BaseComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                var editorResMode = EditorGUILayout.BeginToggleGroup("Editor Resource Mode", m_EditorResourceMode.boolValue);
                if (m_EditorResourceMode.boolValue != editorResMode)
                {
                    m_EditorResourceMode.boolValue = editorResMode;
                    if (editorResMode) BuildSettings.AllScenes();
                    else BuildSettings.DefaultScenes();
                }
                {
