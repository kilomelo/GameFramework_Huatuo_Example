...
namespace UnityGameFramework.Editor.ResourceTools
{
    public sealed partial class ResourceBuilderController
    {
        private sealed class BuildReport
        {
            ...
            private long m_DynamicAssemblyPlatforms = 0;
                ...
                Platform platforms, long dynamicAssemblyPlatforms, AssetBundleCompressionType assetBundleCompression, string compressionHelperTypeName, bool additionalCompressionSelected, bool forceRebuildAssetBundleSelected, string buildEventHandlerTypeName, string outputDirectory, BuildAssetBundleOptions buildAssetBundleOptions, SortedDictionary<string, ResourceData> resourceDatas)
            {
                ...
                m_DynamicAssemblyPlatforms = dynamicAssemblyPlatforms;
            ...
            public void SaveReport()
            {
                ...
                xmlElement = xmlDocument.CreateElement("DynamicAssemblyPlatforms");
                xmlElement.InnerText = m_DynamicAssemblyPlatforms.ToString();
                xmlSummary.AppendChild(xmlElement);
